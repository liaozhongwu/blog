...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pageBlog = __webpack_require__(168);

	var _pageBlog2 = _interopRequireDefault(_pageBlog);

	var props = window.APP_PROPS;
	_reactDom2['default'].render(_react2['default'].createElement(_pageBlog2['default'], props), document.getElementById("app"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _showdown = __webpack_require__(169);

	var _showdown2 = _interopRequireDefault(_showdown);

	var _clientAjax = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
		...
		function _request() {
			...
			// handle url template
			url = url.replace(/:([^\/]+)|\{([^\/]+)\}/g, function (match, p) {
				return options[p] ? options[p] : p;
			});
